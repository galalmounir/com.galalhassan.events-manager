// This regenerator is based on the work of Serhii Yolkin (AKA: ZimM-LostPolygon on Github).
// All credit goes to their GIST on https://gist.github.com/ZimM-LostPolygon/7e2f8a3e5a1be183ac19
using System;
...
public class UnityGUIDRegeneratorMenu {
        [MenuItem("Tools/Regenerate Package GUIDs")]
        public static void RegenerateGuids() {
            if (EditorUtility.DisplayDialog("GUIDs regeneration",
                "You are going to start the process of Package GUID regeneration. This may have unexpected results. \n\nMAKE A BACKUP OF YOUR PACKAGE BEFORE PROCEEDING!",
                "Regenerate Package GUIDs", "Cancel")) {
                try {
                    AssetDatabase.StartAssetEditing();

                    string path = Path.GetFullPath(".") + Path.DirectorySeparatorChar + "package_source";
